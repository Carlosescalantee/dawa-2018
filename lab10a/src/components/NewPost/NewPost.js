	...
	render() {
		...
		return(
			...
			<input
					...
					onChange={(event) => this.setState({ title: event.target.value} )} /><br /><br />
			<label>Content:</label>
			<textarea rows="4" value={this.state.content}
					onChange={(event) => this.setState({ content: event.target.value} )} /><br /><br />
			<label>Author:</label>

			<select value={this.state.author}
					onChange={(event) => this.setState({ author: event.target.value} )} ><br />
